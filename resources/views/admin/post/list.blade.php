                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->title }}</td>
                                    <td width="5%">{{ $row->category->name }}</td>
                                    <td width="9%">{{ $row->creator->name }}</td>
                                    <td width="5%">{{ count($row->comments) }}</td>
                                    <td width="5%">{{ $row->view_count }}</td>
                                    <td width="6%">
                                    ...
                                    <td width="17%">
                                        ...
                                        <a href="{{ url('/back/posts/edit/'.$row->id)}}"
